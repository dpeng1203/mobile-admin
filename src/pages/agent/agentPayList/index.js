            ...
            <div className="agent-pay-list">
                ...
                { this.state.dataList.map( item =>{
                    ...
                    <div className="content">
                        ...
                        <div className="detail">代理商代付费率<span>{item.sup_rate}</span></div>
                        <div className="detail">子商户代付费率<span>{item.sub_rate}</span></div>
                        <div className="detail">代付费率差<span>{item.bank_rate}</span></div>
                    </div>
                    <div className="foot">
